/*
	GoPerpus
	Program yang dibuat untuk memenuhi tugas UAS Algorithma dan Pemrograman

	Anggota Kelompok 5 :
	Christa Putri Rahayu 21.11.3835
	Salma Tsabitatul Fauziyah 21.11.3848
	Yanu Mario 21.11.3853
	Kaikara Dharma Pradipta 21.11.3888
	Mario Christian Adi 21.11.3889
...
mulaimenu: //mulai menu
	...
	inbuk:
		...
		cout << " Kode Buku \t\t:"; scanf_s("%d%c", &buku[b].kodeB, &temp);
		cout << " judul Buku\t\t:"; gets_s(buku[b].judul);
		cout << " Harga Sewa \t\t:"; scanf_s("%d%c", &buku[b].sewa, &temp);
		cout << " Jumlah Buku\t\t:"; scanf_s("%d%c", &buku[b].stock, &temp);
		cout << endl;
	...
	transaksipinjem:
		...
		cout << " Kode Pinjaman \t\t\t:"; scanf_s("%d%c", &pinjembuku[d].kodepinjam, &temp);
		cout << " Kode Buku \t\t\t:"; scanf_s("%d%c", &pinjembuku[d].kB, &temp);
		...
		cout << " Nama Penyewa Buku \t\t:"; gets_s(pinjembuku[d].namap);
		cout << " Alamat Penyewa \t\t:"; gets_s(pinjembuku[d].alamat);
		cout << " Tanggal Pinjam (DDMMYYYY)\t:"; scanf_s("%d%c", &pinjembuku[d].tglpin, &temp);
		cout << " Tanggal Balik (DDMMYYYY)\t:"; scanf_s("%d%c", &pinjembuku[d].tglbalik, &temp);
		lp = (pinjembuku[d].tglbalik - pinjembuku[d].tglpin) / 1000000;
		cout << " Lama Pinjaman \t\t\t:" << lp << " Hari" << endl;
		cout << " banyak buku yang di pinjam  \t:"; scanf_s("%d%c", &pinjembuku[d].dipinjem, &temp);
	...
	pengembalian:
		...
		cout << "-- Program Aplikasi Perpustakaan Kelompok 5 --\n";
		system("pause");
		system("cls");
		goto login;
